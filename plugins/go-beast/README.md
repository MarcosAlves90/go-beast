...
This directory packages the canonical `skills/go-*` skills in a plugin-friendly layout for
optional surfaces that expect a plugin bundle with a dedicated `skills/`
directory.

## Scope

- `skills/` contains symlinks to the canonical `skills/go-*` directories
...
This keeps `plugins/go-beast/skills/` aligned with the canonical `skills/`
directory.
